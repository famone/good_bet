<template>
	<footer>
		<div class="container">
			<div class="col-lg-2">
				<img alt="$t('footer.casinoName')" src="../../assets/img/logo.svg" class="logo">
				<p class="slogan" v-html="$t('footer.slogan')"></p>
			</div>
			<div class="col-lg-2 col-lg-offset-1">
			 		<h5>{{ $t('footer.casinoName') }}</h5>
			 		<ul>
			 ...
			 <div class="col-lg-4">
                ...
                <router-link tag="li" to="/game-groups/127">{{ $t('main.liveCasino') }}</router-link>
			 				</ul>
			 		</div>
					<div class="col-lg-6">
			 				<ul class="flex-footer">
...
<script>
import betCard from '../ui/betCard.vue'
